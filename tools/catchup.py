...
print("  Tests: tools/make_test_copy.py, then /dev-tests.html on the TEST server, port 8767 (356 checks: all of dev-*.js incl. dev-rev3.js, dev-audit.js, dev-morph.js; no Node), tools/test_pa_import.py (41), tools/test_server_guards.py (12), tools/test_offline_update.py (37), tools/test_fable_a.py (14), tools/qa_crawl.py (every control, add --desktop), tools/perf_motion.py (lite, reduced), tools/qa_matrix.py, tools/qa_taborder.py. Run player flows end to end in real time too.")
