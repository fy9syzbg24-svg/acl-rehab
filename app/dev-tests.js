...
import { collectRecords, fingerprint } from './js/sync/records.js';
import { mergeDocs, stampChanges, stampAll, pendingCount } from './js/sync/merge.js';
...
window.process.exit(fails.length ? 1 : 0);
