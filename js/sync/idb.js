...
function open() {
  ...
  dbPromise = new Promise((resolve, reject) => {
    ...
    req.onsuccess = () => {
      ...
      // WebKit can drop the connection after the app has been in the
      // background ("Connection to Indexed Database server lost"); reopen on
      // the next save instead of failing every save until a relaunch.
...
const BUCKETS = ['measurements', 'mrss', 'customExercises', 'supplements', 'prnMeds', 'doses',
  'planGoals', 'planFocus', 'days', 'caseFile', 'settings', 'program', 'melbourne', 'pk'];
