...
export const KINDS = [
  ['tendon', 'Tendon loading is due', 'An hour after you mark your collagen.'],
  ...
  // Shot day. The switch says what it is; the notification never does (his
  // rule, 2026-09-20), so a glance at his Lock Screen gives nothing away.
  ['cycle', 'Shot day', 'Once, on the day one is due, at a time you pick. The notification says only that today is the day.', 'cycleAt', '17:00'],
];
