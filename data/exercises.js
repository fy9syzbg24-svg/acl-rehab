...
export const EXERCISES = [
  ...
  { id: 'rfe_split_squat', name: 'Split squat, rear foot elevated', cat: 'strength', months: [1, 2, 3, 4, 5, 6], track: 'setsreps', clinic: true },
  { id: 'wall_squat_ball_shift', name: 'Mini wall squat with a ball, shifting weight and lifting one leg', cat: 'strength', months: [1, 2, 3], track: 'setsreps', clinic: true },
  { id: 'triple_extension', name: 'Triple extension, single leg', cat: 'strength', months: [1, 2, 3, 4], track: 'setsreps', clinic: true },
  ...
  { id: 'tendon_load_iso_lunge', name: 'Tendon loading lunge, isometric hold', cat: 'strength', months: [1, 2, 3, 4, 5, 6], track: 'time', clinic: true, secs: true },
  { id: 'hip_abd_90_band', name: 'Hip abduction at 90°, band', cat: 'strength', months: [1, 2, 3, 4, 5, 6], track: 'setsreps', clinic: true, usesBand: true },
  { id: 'hip_abd_60_band', name: 'Hip abduction at 60°, band', cat: 'strength', months: [1, 2, 3, 4, 5, 6], track: 'setsreps', clinic: true, usesBand: true },
  { id: 'standing_hip_abd_power_band', name: 'Standing hip abduction in power position, band', cat: 'strength', months: [1, 2, 3, 4, 5, 6], track: 'setsreps', clinic: true, usesBand: true },
  { id: 'kb_deadlift_hold', name: 'Kettlebell deadlift hold, 12 inch', cat: 'strength', months: [1, 2, 3, 4, 5, 6], track: 'time', clinic: true, secs: true },
  { id: 'wall_squat', name: 'Wall squat', cat: 'strength', months: [1, 2, 3, 4, 5, 6], track: 'time', clinic: true, secs: true },
  ...
  { id: 'tall_to_short', name: 'Tall to short, landing in an athletic stance', cat: 'impact', months: [1, 2, 3, 4], track: 'setsreps', clinic: true },
  ...
  { id: 'tipping_birds_foam', name: 'Tipping birds on foam', cat: 'balance', months: [1, 2, 3, 4], track: 'setsreps', clinic: true },
  ...
  { id: 'elliptical', name: 'Elliptical or bike', cat: 'aerobic', months: [1, 2, 3, 4, 5, 6], track: 'time', cardio: true, gym: true,
    note: 'Interchangeable. He owns an elliptical; use a bike instead whenever one is to hand.' },
  ...
  // ---- Dance and show ---------------------------------------------------
  { id: 'show_rehearsal', name: 'Magic Show Rehearsal: mental rehearsal and upper body marking', cat: 'dance', months: [1, 2, 3, 4, 5, 6], track: 'time', clinic: true },
  ...
  // ---- The custom workout (2026-09-18) ------------------------------------
  // What a run of the custom workout timer logs as (customworkout.js). No
  // category on purpose: it is whatever he sets it up for, so it never counts
  // towards a category's weekly target on its own. Never offered in the
  // picker; it is started from its own card on Today.
  { id: 'custom_workout', name: 'Custom workout', months: [], track: 'time', timer: true, tint: 'var(--ink-2)' },
];
