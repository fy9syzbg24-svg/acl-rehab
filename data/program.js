...
//
// EVERY PROGRESSION NAMES ITS SOURCE; NONE WITHOUT ONE (his rule, 23 Sep 2026,
// after finding steps on the tendon loading that no clinician gave). Each entry
// is { t, by, src }:
//   t    the step as it reads on screen
//   by   who set it, as a code, never a name (this repo is public):
//        'pm' his Melbourne physio (Performance Medicine), 'col' his New York
//        physio (Columbia). The names live in his synced data,
//        caseFile.sourceNames, and the screen reads "Hold 4 kg (Name)".
//   src  where it was set (an email and its date, or PhysiApp), kept here and
//        never shown
// An entry with no `by` is dropped by js/progressions.js and never shown. His
// own steps are not here: they live in program.ownSteps and read "(Ours)".
...
export const REHAB_PROGRAM = [
  {
    ...
    progressions: [
      { t: 'Single-leg bridge, exercises 2 and 3 below', by: 'pm', src: '3 Aug 2026 email' },
      { t: 'Add weight over the hips', by: 'pm', src: '3 Aug 2026 email' },
    ],
  },
  {
  ...
  },
  {
    ...
    progressions: [
      { t: 'Split stance', by: 'pm', src: 'PhysiApp' },
      { t: 'Single leg', by: 'pm', src: 'PhysiApp' },
    ],
  },
  {
  ...
  },
  {
    ...
    progressions: [
      { t: 'Increase the resistance or weight', by: 'pm', src: '3 Aug 2026 email' },
      { t: 'Perform in time to a metronome or song', by: 'pm', src: '3 Aug 2026 email' },
    ],
  },
  {
    ...
    progressions: [
      { t: 'Increase the hold time at the bottom', by: 'pm', src: '3 Aug 2026 email' },
      { t: 'Perform on a foam mat', by: 'pm', src: '3 Aug 2026 email' },
    ],
  },
  {
    ...
    progressions: [
      { t: 'Increase the hold time at the top', by: 'pm', src: '3 Aug 2026 email' },
      { t: 'No hand support', by: 'pm', src: 'PhysiApp' },
      { t: 'Perform on a foam mat', by: 'pm', src: '3 Aug 2026 email' },
    ],
  },
  {
    ...
    progressions: [
      { t: 'Increase the time', by: 'pm', src: '3 Aug 2026 email' },
      { t: 'Build to 30-second intervals over 3 min 30 s', by: 'pm', src: '3 Aug 2026 email' },
    ],
  },
  {
  ...
  },
  {
    ...
    progressions: [
      { t: 'Hold 4 kg', by: 'pm', src: 'PhysiApp, 23 Sep 2026' },
      { t: 'Slow the speed down', by: 'pm', src: '3 Aug 2026 email' },
      { t: 'Increase the height of the step', by: 'pm', src: '3 Aug 2026 email' },
    ],
    // Their program moved this to a 4 kg hold on 23 Sep. His call: offer it, he decides.
    suggest: { stage: 1, from: '2026-09-23', text: 'Your physio moved this on to holding 4 kg.' },
  },
  {
  ...
  // --- from the user's typed list, not in the PhysiApp program ---------------
  {
    ...
    progressions: [
      { t: 'Increase the depth of the hip drop and lift', by: 'pm', src: '3 Aug 2026 email' },
    ],
  },
  {
    ...
    // No progressions: none came from his clinician. The two that were here were
    // written on 12 Sep with no source and are removed (his call, 23 Sep: only
    // progressions his physio set). The point is tendon activation, not load.
  },
  {
  ...
  // --- added to the clinician's PhysiApp program on 23 Sep 2026 --------------
  // Read from PhysiApp itself. Prescriptions and wording are theirs. Items 27 to
  // 29 are the clinic's own recordings of real people, so their pictures never
  // go in this public shell.
  {
    n: 25, id: 'pa25', timer: 'reps', freq: 3, ex: 'rfe_split_squat', title: 'Split squat, rear foot elevated',
    img: 'img/program/ex-25.jpg', thumb: 'img/program/ex-25-thumb.jpg',
    sides: 'each', sets: 3, reps: 8,
    steps: [
      'Stand with your back to the step and place your good leg onto the step.',
      'Make sure there is a large distance between your front foot and your back foot.',
      ...
      'Keep your front knee from going in front of your front toe, and bring your hips straight down.',
    ],
  },
  {
    n: 26, id: 'pa26', timer: 'reps', freq: 2, ex: 'wall_squat_ball_shift', title: 'Mini wall squat with a ball, shifting weight and lifting one leg',
    img: 'img/program/ex-26.jpg', thumb: 'img/program/ex-26-thumb.jpg',
    sides: 'both', sets: 3, reps: 5, hold: '3s',
    steps: [
      'Stand with the ball between a wall and your lower back, feet in front of you so your knees stay in line with your heels as you squat.',
      'Activate your deep stabilising muscles and gently squat a quarter range.',
      'Tense your bottom muscles at the bottom of the squat and keep them tense as you shift your weight from side to side.',
      'Do not let your hip drop to the side.',
      'As you practise, lift one leg off the floor as you move to the other side. Hold, then swap sides.',
    ],
  },
  {
    n: 27, id: 'pa27', timer: 'reps', freq: 7, ex: 'tipping_birds_foam', title: 'Tipping birds on foam, level 4',
    sides: 'each', sets: 3, reps: 8,
    steps: [
      'Weight on the front foot, knee slightly bent.',
      'Send your hips backwards and tip your torso over while lifting the back foot off the floor.',
      'Use your glutes to stand upright and drive the knee up to your navel.',
      'Slowly lower the leg back to the ground and reset.',
    ],
  },
  {
    n: 28, id: 'pa28', timer: 'reps', freq: 3, ex: 'triple_extension', title: 'Triple extension',
    sides: 'each', sets: 3, reps: 6,
    goal: '10 on one leg, with good speed and control',
    steps: [
      'Stand on one leg.',
      'Level 1: send your hips backwards and hold until you feel your glute working, then slowly come back up to straight using your glutes rather than your quads.',
      'Level 2: come up to straight quickly using your glutes.',
      'Level 3: come up into a rise onto the toes (relevé).',
      'Level 4: jump off the ground, keeping the glutes engaged.',
    ],
    progressions: [
      { t: 'Level 2: come up to straight quickly using your glutes', by: 'pm', src: 'PhysiApp, 23 Sep 2026' },
      { t: 'Level 3: come up into a rise onto the toes (relevé)', by: 'pm', src: 'PhysiApp, 23 Sep 2026' },
      { t: 'Level 4: jump off the ground, keeping the glutes engaged', by: 'pm', src: 'PhysiApp, 23 Sep 2026' },
    ],
  },
  {
    n: 29, id: 'pa29', timer: 'reps', freq: 3, ex: 'tall_to_short', title: 'Tall to short',
    sides: 'both', sets: 3, reps: 8,
    goal: '15 on both legs, faster, with good landing control',
    steps: [
      'Reach up onto your toes, then quickly pull down and land in an athletic stance.',
    ],
    notes: ['Imagine you are on a ski erg as you drop into the squat position.'],
    progressions: [
      { t: 'Single leg: land on one bent leg, and control and stick the landing', by: 'pm', src: 'PhysiApp, 23 Sep 2026' },
    ],
  },

  // --- his own, 23 Sep 2026: his physio's performance goal, three a week ------
  {
    n: 30, id: 'ms30', timer: 'manual', freq: 3, ex: 'show_rehearsal', title: 'Magic Show Rehearsal', typed: true,
    sides: 'both',
    steps: [
      'Mental rehearsal of the show, start to finish.',
      'Mark the choreography with the upper body.',
    ],
  },
];
